                    ...
                    <div class="body">
                        <form class="form-horizontal" action="{{ route('website_setting.update', $website_setting->id) }}"
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-8 col-xs-7 mb-3">
                                ...
                                <div class="form-group">
                                    <div class="mb-2" style="border: 1px solid #ccc">
                                        <input type="file" class="form-control" id="customFile" / name="website_logo">
                                    </div>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-8 col-xs-7 mb-3">
                                ...
                                <div class="form-group">
                                    <div class="mb-2" style="border: 1px solid #ccc">
                                        <input type="file" name="website_footer_logo" class="form-control" id="customFile" />
                                    </div>
                                    <img src="{{ asset($website_setting->website_footer_logo) }}" alt="" width="40">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-8 col-xs-7 mb-3">
                                ...
                                <div class="form-group">
                                    <div class="mb-2" style="border: 1px solid #ccc">
                                        <input type="file" name="website_footer_bg" class="form-control" id="customFile" />
                                    </div>
                                    <img src="{{ asset($website_setting->website_footer_bg) }}" alt="" width="40">
                                </div>
                            </div>
